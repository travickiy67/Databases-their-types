...
*1. Выбор способа пополнения баланса.*   
...
*6. Пользователь получает информацию о пополнении счета*  
2.1.* Какие действия должны произойти, если пополнение счёта телефона происходило бы через автоплатёж?

**1. Транзакция, передача ининформации провайдеру.**  
**2. Пользователь получает информацию о пополнении счета**  
